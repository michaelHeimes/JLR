	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<section id="recent-event">
				...
				<div id="tickets-directions-wrap">
					<a id="tickets" href="<?php the_field('link_to_tickets');?>" target="_blank">
						<p>Buy Tickets<i class="fas fa-ticket-alt"></i></p>
					</a>
					<a id="directions" href="<?php the_field('directions_link');?>" target="_blank">
						<p><i class="fas fa-map-pin"></i>Get Directions</p>
					</a>
				</div>
